...
import smart.form.mapper.ConBillingMapper;
...
public class ConBillingServiceImpl extends ServiceImpl<ConBillingMapper, ConBillingEntity> implements ConBillingService {
    ...
    public void save(String id, ConBillingEntity entity) throws WorkFlowException {
        ...
        if (id == null) {
            ...
            this.save(entity);
            billRuleApi.useBillNumber("WF_ConBillingNo");
            //添加附件
    ...
    @Override
    @Transactional(rollbackFor = WorkFlowException.class)
    public void submit(String id, ConBillingEntity entity) throws WorkFlowException {
        //表单信息
        if (id == null) {
            entity.setId(RandomUtil.uuId());
            this.save(entity);
