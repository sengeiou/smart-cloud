...
import smart.form.mapper.MonthlyReportMapper;
 ...
 */
@Service
public class MonthlyReportServiceImpl extends ServiceImpl<MonthlyReportMapper, MonthlyReportEntity> implements MonthlyReportService {
    ...
    public void save(String id, MonthlyReportEntity entity) throws WorkFlowException {
        ...
        if (id == null) {
            ...
            this.save(entity);
            billRuleApi.useBillNumber("WF_MonthlyReportNo");
            //添加附件
    ...
    @Override
    @Transactional(rollbackFor = WorkFlowException.class)
    public void submit(String id, MonthlyReportEntity entity) throws WorkFlowException {
        //表单信息
        if (id == null) {
            entity.setId(RandomUtil.uuId());
            this.save(entity);
