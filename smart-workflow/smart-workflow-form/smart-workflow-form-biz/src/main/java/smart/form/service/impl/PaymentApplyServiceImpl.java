...
import smart.form.mapper.PaymentApplyMapper;
...
public class PaymentApplyServiceImpl extends ServiceImpl<PaymentApplyMapper, PaymentApplyEntity> implements PaymentApplyService {
    ...
    public void save(String id, PaymentApplyEntity entity) throws WorkFlowException {
        ...
        if (id == null) {
            ...
            this.save(entity);
            billRuleApi.useBillNumber("WF_PaymentApplyNo");
        } else {
            entity.setId(id);
    ...
    @Override
    @Transactional(rollbackFor = WorkFlowException.class)
    public void submit(String id, PaymentApplyEntity entity) throws WorkFlowException {
        //表单信息
        if (id == null) {
            entity.setId(RandomUtil.uuId());
            this.save(entity);
