...
import smart.form.mapper.BatchTableMapper;
 ...
 */
@Service
public class BatchTableServiceImpl extends ServiceImpl<BatchTableMapper, BatchTableEntity> implements BatchTableService {
    ...
    public void save(String id, BatchTableEntity entity) throws WorkFlowException {
        ...
        if (id == null) {
            ...
            this.save(entity);
            billRuleApi.useBillNumber("WF_BatchTableNo");
            //添加附件
    ...
    @Override
    @Transactional(rollbackFor = WorkFlowException.class)
    public void submit(String id, BatchTableEntity entity) throws WorkFlowException {
        //表单信息
        if (id == null) {
            entity.setId(RandomUtil.uuId());
            this.save(entity);
