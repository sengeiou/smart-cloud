...
public class Template3Model {
    ...
    // 列表主表 - 字段集合
    private List<IndexGridField3Model> indexGridField;
    // 列表子表 - 子表集合
    private List<IndexGridEntry3Model> indexGridEntry;
    // 数据关联 - 集合
    private List<DbTableRelation3Model> dbTableRelation;
    // 表单控件 - 集合
    private List<FormControl3Model> formControls;
}
