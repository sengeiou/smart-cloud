...
public class DbConUtil {
    public static List<DbTableConModel> mysqlgetList(Connection conn, String dnname) throws DataException {
    ...
    public static List<DbTableConModel> sqlServergetList(Connection conn, String dnname) throws DataException {
        List<DbTableConModel> list = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
    ...
    public static List<DbTableConModel> orcalgetList(Connection conn, String dnname) throws DataException {
        List<DbTableConModel> list = new ArrayList<>();
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT " +
