...
if not exist "C:\Program Files\Java\jdk1.8.0_271\bin\java.exe" echo Please set the JAVA_HOME variable in your environment, We need java(x64)! jdk8 or later is better! & EXIT /B 1
set "JAVA=C:\Program Files\Java\jdk1.8.0_271\bin\java.exe"
...
set "NACOS_OPTS=%NACOS_OPTS% -jar %BASE_DIR%\bin\%SERVER%.jar"
